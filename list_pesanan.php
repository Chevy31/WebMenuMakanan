    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          <?php $nomor=1; ?>
          <?php 
            $ambil = mysqli_query($koneksi, 'SELECT * FROM list');
          ...
          <tr>
            ...
            <td><?php echo $result["id_pesan"]; ?></td>
            <td><?php echo $result["tanggal_pesan"]; ?></td>
            <td>Rp. <?php echo number_format($result["total_pesan"]); ?></td>
            <td>
              
              <a href="detail_pesanan.php?id=<?php echo $result['id_pesan'] ?>" class="badge badge-primary">Detail</a>
             

              <a href="delete_pesanan.php?id=<?php echo $result['id_pesan'] ?>" class="badge badge-danger">Hapus Data</a>
            </td>
          </tr>
          <?php $nomor++; ?>
          <?php endforeach; ?>
